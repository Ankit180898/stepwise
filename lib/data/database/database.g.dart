...
class $HabitsTable extends Habits with TableInfo<$HabitsTable, Habit> {
  ...
  static const VerificationMeta _totalCompletionMeta =
      const VerificationMeta('totalCompletion');
  @override
  late final GeneratedColumn<int> totalCompletion = GeneratedColumn<int>(
      'total_completion', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const Constant(0));
  ...
  VerificationContext validateIntegrity(Insertable<Habit> instance,
    ...
    if (data.containsKey('total_completion')) {
      context.handle(
          _totalCompletionMeta,
          totalCompletion.isAcceptableOrUnknown(
              data['total_completion']!, _totalCompletionMeta));
    }
  ...
  Habit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Habit(
      ...
      totalCompletion: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}total_completion'])!,
...
class Habit extends DataClass implements Insertable<Habit> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['total_completion'] = Variable<int>(totalCompletion);
  ...
  HabitsCompanion toCompanion(bool nullToAbsent) {
    return HabitsCompanion(
      ...
      reminderTime: reminderTime == null && nullToAbsent
          ...
          : Value(reminderTime),
      streak: Value(streak),
      totalCompletion: Value(totalCompletion),
  ...
  factory Habit.fromJson(Map<String, dynamic> json,
    ...
    return Habit(
      ...
      totalCompletion: serializer.fromJson<int>(json['totalCompletion']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'totalCompletion': serializer.toJson<int>(totalCompletion),
  ...
  Habit copyWith(
      ...
      Habit(
        ...
        totalCompletion: totalCompletion ?? this.totalCompletion,
  ...
  Habit copyWithCompanion(HabitsCompanion data) {
    return Habit(
      ...
      totalCompletion: data.totalCompletion.present
          ? data.totalCompletion.value
  ...
  String toString() {
    return (StringBuffer('Habit(')
          ...
          ..write('streak: $streak, ')
          ..write('totalCompletion: $totalCompletion, ')
  ...
  @override
  int get hashCode => Object.hash(id, title, desc, createdAt, reminderTime,
      streak, totalCompletion, isDaily);
  @override
  bool operator ==(Object other) =>
      ...
      (other is Habit &&
          ...
          other.totalCompletion == this.totalCompletion &&
...
class HabitsCompanion extends UpdateCompanion<Habit> {
  ...
  final Value<int> totalCompletion;
  ...
  const HabitsCompanion({
    ...
    this.totalCompletion = const Value.absent(),
  ...
  static Insertable<Habit> custom({
    ...
    Expression<int>? totalCompletion,
    ...
    return RawValuesInsertable({
      ...
      if (totalCompletion != null) 'total_completion': totalCompletion,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (totalCompletion.present) {
      map['total_completion'] = Variable<int>(totalCompletion.value);
    }
    if (isDaily.present) {
...
class $$HabitsTableFilterComposer
  ...
  ColumnFilters<int> get totalCompletion => $composableBuilder(
      column: $table.totalCompletion,
...
class $$HabitsTableOrderingComposer
  ...
  ColumnOrderings<int> get totalCompletion => $composableBuilder(
      column: $table.totalCompletion,
      builder: (column) => ColumnOrderings(column));
...
class $$HabitsTableAnnotationComposer
  ...
  GeneratedColumn<int> get totalCompletion => $composableBuilder(
      column: $table.totalCompletion, builder: (column) => column);
  ...
  $$HabitsTableTableManager(_$AppDatabase db, $HabitsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> totalCompletion = const Value.absent(),
